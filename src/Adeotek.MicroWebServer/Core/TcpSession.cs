...
namespace Adeotek.MicroWebServer.Core
{
    ...
    public class TcpSession : ISession
    {
        ...
        public void Connect(Socket socket) //internal
        {
            Socket = socket;
        ...
        public virtual long Send(byte[] buffer, long offset, long size)
        {
            ...
            if (sent > 0)
            {
                // Update statistic
                BytesSent += sent;
                Interlocked.Add(ref ((TcpServer)Server)._bytesSent, size);
        ...
        public virtual long Receive(byte[] buffer, long offset, long size)
        {
            ...
            if (received > 0)
            {
                ...
                Interlocked.Add(ref ((TcpServer)Server)._bytesReceived, received);
        ...
        private bool ProcessReceive(SocketAsyncEventArgs e)
        {
            ...
            if (size > 0)
            {
                // Update statistic
                BytesReceived += size;
                Interlocked.Add(ref ((TcpServer)Server)._bytesReceived, size);
        ...
        {
            OnSessionConnected?.Invoke(this, new ConnectionEventArgs(Id));
        }
        ...
        {
            OnSessionDisconnected?.Invoke(this, new ConnectionEventArgs(Id));
        }
