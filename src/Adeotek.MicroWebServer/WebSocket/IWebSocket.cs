...
namespace Adeotek.MicroWebServer.WebSocket
{
    public interface IWebSocket
    {
        ...
        void OnWsConnecting(Request request)
        {
        }
        ...
        void OnWsConnected(Response response)
        {
        }
        ...
        bool OnWsConnecting(Request request, Response response)
        {
            return true;
        }
        ...
        /// </summary>
        /// <param name="request">WebSocket upgrade HTTP request</param>
        void OnWsConnected(Request request)
        {
        }
