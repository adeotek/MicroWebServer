...
namespace Adeotek.MicroWebServer.WebSocket
{
    ...
    public class Buffer
    {
        ...
        public string ExtractString(long offset, long size)
        {
            ...
            if (offset + size > Size) throw new ArgumentException("Invalid offset & size!", nameof(offset));
        ...
        public void Reserve(long capacity)
        {
            ...
            if (capacity < 0) throw new ArgumentException("Invalid reserve capacity!", nameof(capacity));
