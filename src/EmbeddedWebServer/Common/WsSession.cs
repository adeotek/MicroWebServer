...
using NetCoreServer;
using NetCoreWsSession = NetCoreServer.WsSession;
using NetCoreWsServer = NetCoreServer.WsServer;

namespace Adeotek.EmbeddedWebServer.Common
{
    public class WsSession : NetCoreWsSession, IWebSocketSession
    {
        public WsSession(NetCoreWsServer server) : base(server)
        {
        }
